...
/** Botão flutuante de WhatsApp, fixo no canto inferior. */
export function WhatsappFab() {
  ...
  return (
    <a
      href={whatsappLink(whatsapp, WHATSAPP_ENROLL_MESSAGE)}
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Falar no WhatsApp"
      className={`fixed bottom-6 right-6 z-40 flex size-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_10px_30px_-6px_rgba(37,211,102,0.6)] transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] hover:scale-110 ${
